        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_BankCards_DestinationCardId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionCardTypes_TransactionTypeModels_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionStatuses_TransactionStatusModels_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionCardTypes_TransactionId",
                table: "TransactionCardTypes",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionCardTypes_TypeId",
                table: "TransactionCardTypes",
                column: "TypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionStatuses_StatusId",
